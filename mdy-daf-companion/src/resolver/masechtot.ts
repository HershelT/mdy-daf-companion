...
export function normalizeMasechta(value: string | null | undefined): string | null {
  if (!value) {
    return null;
  }
  const cleaned = value
...
export function masechtaMatches(left: string | null | undefined, right: string | null | undefined): boolean {
